...
data Universe a where
    Bool    :: Universe Bool
    Integer :: Universe Integer

data UnOp a b where
    Not  :: UnOp Bool Bool
    Neq0 :: UnOp Integer Bool

data BinOp a b c where
    Or  :: BinOp Bool Bool Bool
    And :: BinOp Bool Bool Bool
    Xor :: BinOp Bool Bool Bool
    Add :: BinOp Integer Integer Integer
    Mul :: BinOp Integer Integer Integer
...
withGeqUniverse Integer Integer y _ = y
...
instance Eq (Expr a) where
    ...
    EVal Integer i1    == EVal Integer i2    = i1 == i2
